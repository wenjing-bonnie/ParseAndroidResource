...
import com.wj.parse.androidresource.parse.ParseResourceManager
...
fun main(args: Array<String>) {
    ...
    val resourcePath =
        "/Users/wendli/Documents/personal/ParseAndroidResource/app/src/resource/resources.arsc"
    val result = getResourceFromInputStream(FileInputStream(File(resourcePath)))

    result?.let { array ->
        val manager = ParseResourceManager()
        ...
        /** read [ResStringPoolRefSecondChunk]*/
        Logger.debug("begin to read second chunk: String Pool ref ......")
        var stringPoolRes: ResStringPoolRefSecondChunk? = null
